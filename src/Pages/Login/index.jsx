...
export default function Login() {
	...
	const validate = (values) => {
		...
		} else if (isNaN(values.emailOrPhone)) {
			if (
				!/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i.test(values.emailOrPhone)
			) {
				//eslint-disable-line
				errors.emailOrPhone = "Email or phone is invalid";
			}
		}
		if (!values.password) {
			...
			errors.password =
				"Password must contain 8 characters with at least, one Upper Case, one number and one special character.";
		}
		return errors;
	};
